...
- The remote code checkout defaults to `origin/main`. Override with `--git-ref <ref>`.
- For exact reproducibility, push your branch or tag a commit and run with that ref.
